...
namespace Listas
{
    class Funciones
    {
        #region "FUNCIONES LISTA OFAC"
            ...
            /// <summary>
        /// Lee Fecha De Publicación Archivo OFAC
        /// </summary>
        /// <param name="urlOfac">Ruta de el archivo de la Lista OFAC</param>
        /// <returns>Devuelve la fecha de publicación de la lista OFAC</returns>
        ...
        /// Lee la lista OFAC
        /// </summary>
        /// <param name="urlOfac">Ruta de el archivo OFAC</param>
        /// <returns>Devuelve Lista IbsStructure con la información de los individuos y entidades encontrados en el archivo</returns>
        ...
        #region  "FUNCIONES LISTA ONU"
            ...
            /// <summary>
            /// Lee la fecha de publicación de la lista ONU de el archivo
            /// </summary>
            /// <param name="urlFile">Ruta del archivo de la lista de control</param>
            /// <returns>Devuelve la fecha de publicación de la lista</returns>
            public static DateTime readONUPublish_Date(string urlFile)
            {
                List<IbsStructure> ibsList = new List<IbsStructure>();
                CapaConexion.Conexion conn = new CapaConexion.Conexion();
                XmlDocument xDoc = new XmlDocument();
            ...
            /// <summary>
            /// Lee archivo de entrada de la lista de control ONU
            /// </summary>
            /// <param name="urlOnu"></param>
            /// <returns>Devuelve una lista IbsStructure</returns>
        ...
        #region FUNCIONES GENERALES
            ...
            /// <summary>Devuelve la lista de las fuentes registradas</summary>
            /// <param name= "Fuente">Nombre de la Lista de control ONU/OFAC</param>
            ...
            /// <summary>Devuelve resumen de la lista</summary>
            /// <param name= "Fuente">Nombre de la Lista de control ONU/OFAC</param>
            ...
            /// <summary>Devuelve la lista actual</summary>
            ...
            /// <summary>Guardar lista</summary>
            /// <param name= "Lista">Lista de individuos</param>
            /// <param name= "FechaLista">Fecha De La Lista De Control Que Viene En Archivo</param>
            /// <param name= "Fuente">Nombre de la fuente ONU/OFAC</param>
            ...
            /// <summary>Obtiene la fecha de la ultima lista cargada</summary>     
            /// <param name= "Fuente">Nombre de la fuente ONU/OFAC</param>
            public static DateTime getLastChargedList(String Fuente){            
                Conexion con = new Conexion();
                return (DateTime) con.DevolverDato("get_UltimaPublicada", "pcodigo", Fuente);
            }
            /// <summary>Convierte de ibsStructure a ibsStructurePlana</summary>     
            /// <param name= "List">Lista ibsStructure a convertir</param>
            public static List<IbsStructurePlana> converToPlain(List<IbsStructure> Lista)
            {            
                var listaEnumerable = Lista.SelectMany(indi => indi.identificaciones,
                        (l, i) => new
                        {
                            l.apellidos,
                            l.causales,
            ...
            /// <summary>Generar Archivo De Salida </summary>     
            /// <param name= "UrlFile">Ruta del archivo de salida</param>
            /// <param name= "Fuente">Nombre de lista de control ONU/OFAC</param>
            ...
            /// <summary>Generar Archivo Historico</summary>     
            /// <param name= "UrlFile">Ruta del archivo de salida</param>
            /// <param name= "Fuente">Nombre de lista de control ONU/OFAC</param>                
